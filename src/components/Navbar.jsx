          ...
          <div
            ...
            <a href="#home" className={commonLinkClasses}>
              <AiOutlineHome
                size={18}
                className={
                  activeSection === 'home' ? activeIconClasses : ''
                }
              />
              <span
                className={
                  activeSection === 'home' ? activeTextClasses : ''
                }>
                Home
              </span>
            </a>
            ...
            <a href="#about" className={commonLinkClasses}>
              <IoPersonOutline
                size={18}
                className={
                  activeSection === 'about' ? activeIconClasses : ''
                }
              />
              <span
                className={
                  activeSection === 'about' ? activeTextClasses : ''
                }>
                About
              </span>
            </a>
            ...
            <a href="#skills" className={commonLinkClasses}>
              <IoSparklesOutline
                size={18}
                className={
                  activeSection === 'skills' ? activeIconClasses : ''
                }
              />
              <span
                className={
                  activeSection === 'skills' ? activeTextClasses : ''
                }>
                Skills
              </span>
            </a>
            ...
            <a href="#projects" className={commonLinkClasses}>
              <FaFolderOpen
                size={18}
                className={
                  activeSection === 'projects' ? activeIconClasses : ''
                }
              />
              <span
                className={
                  activeSection === 'projects' ? activeTextClasses : ''
                }>
                Projects
              </span>
            </a>
            ...
            <a href="#contact" className={commonLinkClasses}>
              <IoMailOutline
                size={18}
                className={
                  activeSection === 'contact' ? activeIconClasses : ''
                }
              />
              <span
                className={
                  activeSection === 'contact' ? activeTextClasses : ''
                }>
                Contact
              </span>
            </a>
