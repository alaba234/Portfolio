...
function HeroSection() {
  ...
  const phrases = ["a Software Engineer", "an Embedded Systems Engineer", "a Problem Solver", "an Electrical Engineer"];
    ...
    <section id='home' className="flex-grow flex flex-col items-center justify-center text-center p-8 relative overflow-hidden pt-24">
      ...
      <div className="container mx-auto px-8 mt-16" >
                <h1 className="text-5xl md:text-5xl lg:text-5xl font-extrabold text-white leading-tight">
                    ...
                    <span className="cursor text-neon-green from-neon-green to-blue-500">|</span>
                </h1>
            </div>
      {/* Main Content (Title, Description) with conditional animation */}
      <div ref={sectionRef} style={{ opacity: contentOpacity }}   className={`mt-16 relative text-center max-w-5xl mx-auto mb-12 transition-all duration-700 ease-out
      ...
      <div className="w-full max-w-7xl mx-auto mb-6"> {/* or max-w-6xl */}
        <div className={`bg-gradient-to-r from-neon-green to-blue-500 rounded-full h-0.5 md:h-1
